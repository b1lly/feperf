 ...
 */
var fepCore, fepProfiler, fepDebug, jquery, fepUiToolbar, fep;
fepCore = function () {
  var _fep = {
    logging: false,
    /**
    ...
    scrollTo: function ($el, opt_speed, opt_topOffset) {
      ...
      $('html, body').animate({ scrollTop: $el.offset().top - opt_topOffset }, opt_speed);
    }
  };
  return _fep;
}();
 ...
 */
fepDebug = function (fep, profiler) {
  var _debug = {};
  ...
  _debug.hasTimingSupport = function () {
    return _debug.hasPerformanceSupport() && typeof window.performance.timing === 'object';
  };
  /**
  ...
  _debug.hasNavigationSupport = function () {
    return _debug.hasPerformanceSupport() && typeof window.performance.navigation === 'object';
  };
  /**
  ...
  _debug.getResourcesByInitiator = function () {
    var entries = [], initiators = {};
    if (_debug.hasPerformanceSupport() && typeof window.performance.getEntries == 'function') {
  ...
  _debug.profileNetwork = function () {
    var _timing, resources = {}, networkLatency = {};
 ...
 */
fepUiToolbar = function ($, fep, debug, profiler) {
  var _toolbar = {}, _performanceMetrics = {};
  ...
  // jQuery Objects
  var $document = undefined, $fepToolbar = undefined;
  /**
  ...
  _toolbar.setResourceLatency = function (data) {
    ...
    for (var metric in data.resourceCountByInitiator) {
      if (domMap[metric]) {
        domMap[metric].first().removeClass('red green yellow').html(data.resourceCountByInitiator[metric]);
      }
    }
  };
  /**
  ...
  _toolbar.updateDom = function (domMap, data, type) {
    var color, currentMetric,
      // Strips 'ms' from metric
      compareMetric;
    // used to compare good or bad performance
    for (var metric in data) {
      ...
      // Update the node
      if (domMap[metric]) {
        domMap[metric].removeClass('red yellow green').html(data[metric]).addClass(color);
      }
    }
  };
  /**
  ...
  _toolbar.linkMetricsToBar = function () {
    $('#fep-debug-toolbar .bar span, #fep-debug-toolbar .metric-details li').hover(function (e) {
      var $self = $(this), $parent = $self.parents('li');
  ...
  return _toolbar;
}(jquery, fepCore, fepDebug, fepProfiler);
fep = function (fep) {
  return fep;
}(fepCore);
window.fep = fep;
